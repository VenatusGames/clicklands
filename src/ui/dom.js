...
export function cacheUI() {
  return {
    ...
    forageStages: {
      forest: document.querySelector('[data-forage-stage="forest"]'),
      mines: document.querySelector('[data-forage-stage="mines"]'),
    },
    enemyStages: {
      forest: document.querySelector('[data-enemy-stage="forest"]'),
      mines: document.querySelector('[data-enemy-stage="mines"]'),
    },
    ...
    combatNoWeapon: document.querySelector('[data-combat-no-weapon]'),
    combatExit: document.querySelector('[data-exit-combat]'),
